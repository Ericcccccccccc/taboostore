...
const translations = {
  en: {
    ...
    saveScoresPrompt: 'Save scores so you can continue this game later?',
    saveScores: 'Save scores',
    discardScores: 'Discard scores',
    continueGame: 'Continue game',
    continueGameBanner: 'Continuing game — {n} round(s) played',
    rounds: 'rounds',
    round_one: 'round',
  },
  ...
  pt: {
    ...
    saveScoresPrompt: 'Salvar pontuações para continuar este jogo depois?',
    saveScores: 'Salvar pontuações',
    discardScores: 'Descartar pontuações',
    continueGame: 'Continuar jogo',
    continueGameBanner: 'Continuando o jogo — {n} rodada(s) jogada(s)',
    rounds: 'rodadas',
    round_one: 'rodada',
  }
};
